...
plt.title('Title1 (Model: '+model+')')
plt.legend()
plt.savefig(output_foldername+"Fitdifference-witherror.pdf")
plt.close()
...
ax.set_xlabel("Time (Gyr)")
ax.set_ylabel("Fractional difference")
plt.title('Title2 (Model: '+model+')')
plt.legend()
plt.savefig(output_foldername+"Fitdifference.pdf")
plt.show()
